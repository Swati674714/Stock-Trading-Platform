        ...
        <div className='container  p-3'>
            <div className='row  p-5'>
                <div className='col-6  p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customers trust Zerodha with Rs 3.5+ lakh crore worth of equality investments.</p>
                    <h2 className='fs-4'>No spam or gimmicks</h2>
                    <p className='text-muted'>No gimmics , spam, "gamification", annoying push notifications, High quality apps that you use at your pace, the way you like.</p>
                ...
                <div className='col-6'>
                    <img src='media\images\photos\ecosystem.png' style={{width:"90%"}}/>
